                    ...
                    <table class="table">
                        ...
                        @foreach ($resources as $resource)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('projects.store_resource', ['project_id' => $project->id, 'resource_id' => $resource->id ]) }}" class="btn btn-default btn-sm" style="font-size: 12px; padding: 1px 10px 0;">Add</a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
